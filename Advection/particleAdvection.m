...
numX = 1100;                 % Number of grid points in the x-direction.
numY = 1100;                 % Number of grid points in the y-direction.

%% Grid definition
xspan = linspace(0,6.28,numX);
yspan = linspace(0,6.28,numY);
